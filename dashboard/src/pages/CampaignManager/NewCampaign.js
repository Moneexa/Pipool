                ...
                <form className="user">
                    ...
                    <div className="form-group row">
                        <div className="form-group col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" className="form-control form-control-user" name="service" id="service" placeholder="Enter the name of your product or service" />
                    ...
                    <div className="form-group row" >
                        <div className="form-group col-sm-6 mb-3 mb-sm-0">
                            ...
                            <label>Do </label>
                            <input type="text" className="form-control form-control-user" id="exampleInputEmail" placeholder="Add a rule - press enter to confirm" />
                    ...
                    <div className="form-group row" >
                        <div id="img_row" className="form-group col-sm-12 mb-3 mb-sm-0">
                            <div className="clearfix">
                                ...
                                <button className="send " data-counter="0">✔</button>
                            </div>
                            <ul>
