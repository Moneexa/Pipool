                    ...
                    <div className="card border-yellow border-5 rounded-20 no-shadow h-100">
                        ...
                        <div className="card-body">
                            <div className="chart-area">
                                ...
                                <div className="card-body">
                                    <h4 className="small font-weight-bold text-grey">Server Migration <span className="float-right">20%</span></h4>
                                    ...
                                    <h4 className="small font-weight-bold text-grey">Sales Tracking <span className="float-right">40%</span></h4>
                                    <div className="progress mb-4">
                                    ...
                                    <h4 className="small font-weight-bold text-grey">Customer Database <span className="float-right">60%</span></h4>
                                    <div className="progress mb-4">
                                        <div className="progress-bar dark-blue" role="progressbar" style={{ "width": "60%" }} aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 className="small font-weight-bold text-grey">Payout Details <span className="float-right">80%</span></h4>
                                    <div className="progress mb-4">
                                    ...
                                    <h4 className="small font-weight-bold text-grey">Account Setup <span className="float-right">Complete!</span></h4>
